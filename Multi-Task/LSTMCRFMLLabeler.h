...
public:
  void train(const string& trainFiles, const string& trainCorpusSize, const string& trainCorpusTags, const string& devFiles, const string& testFiles, const string& testCorpusTags, const string& modelFile, const string& optionFile);
  int predict(const vector<Feature>& features, vector<string>& outputs, const vector<string>& words, int corpusIndex);
